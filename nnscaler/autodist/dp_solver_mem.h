...
struct UnitDPState { //单个动态规划状态的内存和时间消耗信息
  ...
  UnitDPState(int param_related_mem, int activation_mem, int opt_transient_mem,
              int largest_transient_mem_1st, int largest_transient_mem_2nd,
              int max_recompute_mem, int cur_recompute_mem, double time_cost,
