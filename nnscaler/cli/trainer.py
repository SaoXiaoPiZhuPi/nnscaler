...
class Trainer:
    ...
    def _train_epoch(self, epoch: int) -> None:
        ...
        prof=torch.profiler.profile(
                ...
                on_trace_ready=torch.profiler.tensorboard_trace_handler(f"/data/haiqwa/zevin_nfs/andy/Auto-Parallelization/nnscaler_group1/nnscaler-new/examples/logs/tensorbroad/{comm_counter1.date_str}/{comm_counter1.time_str}/{self.train_args.instance_name}",torch.distributed.get_rank()),
                record_shapes=True,
                profile_memory=True,
                with_stack=True)
        #qinghe 
