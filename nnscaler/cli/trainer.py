...
class Trainer:
    ...
    def _train_epoch(self, epoch: int) -> None:
        ...
        prof=torch.profiler.profile(
                ...
                on_trace_ready=torch.profiler.tensorboard_trace_handler(f"/data/haiqwa/zevin_nfs/andy/Auto-Parallelization/nnscaler_group1/nnscaler-0.5/examples/logs/tensorbroad/{date_str}/{time_str}",torch.cuda.current_device()),
                record_shapes=True,
                profile_memory=True,
                with_stack=True)
