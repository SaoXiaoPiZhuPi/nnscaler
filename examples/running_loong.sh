...
export LD_LIBRARY_PATH=/opt/conda/envs/andy/nnscaler_apex/lib:$LD_LIBRARY_PATH
popd
...
data=$(cat running_loong.conf)
declare $data
for DATASIZE in 4;do
    DATASIZE=${DATASIZE}K
    echo DATASIZE=${DATASIZE}
    DATASET_PATH=${DATASET_PATH}${DATASIZE}
    echo ${DATASET_PATH}
    NAME=LLama_6B_apex_RS_4k_pp_run16_plan
    echo ${NAME}
    for PLAN_NGPUS in 4 8 16;do
