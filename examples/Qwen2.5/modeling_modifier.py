...
# This file modifies the official modeling_qwen2.py file at runtime to
...
from transformers.models.qwen2.modeling_qwen2 import Qwen2Attention, QWEN2_ATTENTION_CLASSES, apply_rotary_pos_emb, Qwen2RMSNorm
...
class NNScalerQwen2FlashAttention2(Qwen2Attention):
    """
...
def qwen2_flash_attention_anno(query_states, key_states, value_states, attention_mask, *args, **kwargs) -> str:
...
register_op(qwen2_flash_attention_anno)(nnscaler_flash_attention_forward)
# register_op('b l h d^, b l h d^, b l h d^ -> b l h d^')(flash_attn.flash_attn_interface.FlashAttnFunc.apply)

def nnscaler_qwen2_init():
    QWEN2_ATTENTION_CLASSES["flash_attention_2"] = NNScalerQwen2FlashAttention2
