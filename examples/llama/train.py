...
def main(args):
    ...
    compute_config = ComputeConfig(
        ...
        pas_config={
            ...
            # 'save_plan_path': f"./.nnscaler/_parallel_modules/__main__/WrapperModel/plan_json/{args.name}.json",
            # 'load_plan_path': f"./.nnscaler/_parallel_modules/__main__/WrapperModel/plan_json/{args.name}.json"
        },
    ...
    #type = [MixedPrecisionAdamW, FusedAdam]
    optimizer_config = OptimizerConfig(
        type=FusedAdam,
        # args={'lr': 2e-5, 'betas': (0.9, 0.95), 'weight_decay': 0.0, 'fused': True},
        args={'lr': 2e-5, 'betas': (0.9, 0.95), 'weight_decay': 0.1},
        clip_gnorm=1.0,
        loss_reduction='sum',
